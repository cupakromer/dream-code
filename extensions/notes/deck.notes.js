...
(function($, deck, undefined) {
	...
	*/
    ...
    $d.bind('deck.init', function() {
        ...
        /* Update Notes with deck class, using find in case other extensions
         * wrap the slide (i.e. scale). */
        $.each(slides, function(i, $slide) {
          $slide.find('.notes').addClass(opts.classes.notes);
        });
    })
    .bind('deck.change', function(e, from, to) {
        ...
        /* Update notes */
        if( slideTo.find(".notes").length > 0) {
